...
const NL = {
  ...
  zermeloDesc: "Plak je iCal-link van Zermelo. Je vindt die in Zermelo onder",
  zermeloDescLink: "Instellingen → Kalender → iCal-link",
  saveUrl: "URL opslaan",
  saved: "Opgeslagen ✓",
  syncNow: "Nu synchroniseren",
  syncing: "Synchroniseren…",
  lastSynced: "Laatste synchronisatie",
  autoSyncNote: "De agenda wordt automatisch gesynchroniseerd wanneer je de Agenda-pagina opent.",
...
const EN: typeof NL = {
  ...
  zermeloDesc: "Paste your iCal URL from Zermelo. You can find it in Zermelo under",
  zermeloDescLink: "Settings → Calendar → iCal link",
  saveUrl: "Save URL",
  saved: "Saved ✓",
  syncNow: "Sync now",
  syncing: "Syncing…",
  lastSynced: "Last synced",
  autoSyncNote: "The calendar auto-syncs when you open the Calendar page.",
