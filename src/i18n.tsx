...
const NL = {
  ...
  zermeloDesc: "Plak je externe applicatiecode in het formaat",
  zermeloDescLink: "schoolnaam:extern_app_code",
...
const EN: typeof NL = {
  ...
  zermeloDesc: "Paste your external application code in this format",
  zermeloDescLink: "schoolname:external_app_code",
  saveUrl: "Save code",
  saved: "Saved ✓",
  syncNow: "Sync now",
  syncing: "Syncing…",
